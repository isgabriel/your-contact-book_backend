...
const contact_entities_1 = require("./contact.entities");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => contact_entities_1.Contact, (contact) => contact.user, { cascade: true }),
...
], User.prototype, "encryptInsert", null);
