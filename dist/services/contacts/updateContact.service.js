...
const updateContactService = (payload, oldData) => __awaiter(void 0, void 0, void 0, function* () {
    const contactRepository = data_source_1.AppDataSource.getRepository(contact_entities_1.Contact);
    const updatedContact = contactRepository.create(Object.assign(Object.assign({}, oldData), payload));
